...
g_cont <- g_cont + scale_fill_gradientn(colors = PurpleAndYellow(), name = "Log10(Avg. Exp.)")
...
g_DAPT <- g_DAPT + scale_fill_gradientn(colors = PurpleAndYellow(), name = "Log10(Avg. Exp.)")
...
g_Ratio <- g_Ratio + scale_fill_gradientn(colors = PurpleAndYellow(), name = "Log10(Ratio)")
...
g_T_Pvalue <- g_T_Pvalue + scale_fill_gradientn(colors = PurpleAndYellow(), name = "-Log10(Pval.)")
...
g_W_Pvalue <- g_W_Pvalue + scale_fill_gradientn(colors = PurpleAndYellow(), name = "-Log10(Pval.)")
