...
seuratList <- .stratifySeurat2(seurat.integrated, c("DAPT-36h", "DAPT-48h", "DAPT-72h", "DAPT-96h"))
png(file=outfile2, width=2000, height=650)
.panelPlot2(seuratList, c("DAPT-36h", "DAPT-48h", "DAPT-72h", "DAPT-96h"), "pseudotime")
dev.off()
