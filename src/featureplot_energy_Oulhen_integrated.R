...
energy_DAPT <- unlist(read.table('plot/echinobase/Oulhen/DAPT/Landscaper/E.tsv', header=FALSE))
...
energy_integrated <- unlist(read.table('plot/echinobase/Oulhen/integrated/Landscaper/E.tsv', header=FALSE))
