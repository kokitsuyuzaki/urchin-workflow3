...
snakemake -s workflow/scegot.smk --report report/scegot.html
snakemake -s workflow/palantir.smk --report report/palantir.html
...
snakemake -s workflow/an2.smk --report report/an2.html